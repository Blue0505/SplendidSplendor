...
class Player:
    ...
    def __str__(self):
        ...
        return (
            f"   Gems: {gem_array_str(self._gems, self._gold_gems)}\n"
            f"   {reserved_str}\n"
    ...
    def can_purchase(self, card: Card, using_gold: bool = True) -> bool:
        ...
        purchase_gems: NDArray = (
            card.get_costs_array() - self.get_gems_array() - self.get_resources_array()
        )
